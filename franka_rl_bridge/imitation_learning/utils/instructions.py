...
class InstructionMixin:
    ...
    def print_instructions_testing(self):
        ...
        print("  c: Random spawn")
        print("-" * 90)
        print("Basic Test Cases (0-9):")
        print("  0: Line, centered        │ 1: Spread triangle      │ 2: Vertical line")
        print("  3: Random triangle       │ 4: Long diagonals       │ 5: Line with offset")
        print("  6: Close cluster         │ 7: Far y-range          │ 8: Edge-to-edge test")
        print("  9: Increasing height")
        print("-" * 90)
        print("Extended Test Cases (Letters):")
        print("  y: Centered close        │ u: Side-to-side         │ i: Opposite corners")
        print("  p: Full spread triangle  │ a: Short diagonal       │ d: Inverted triangle")
        print("-" * 90)
        print("Information & Control:")
